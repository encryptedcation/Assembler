...
val_dict= {'KB': 2**13,'MB': 2**23,'GB': 2**33,'Kb': 2**10,'Mb': 2**20,'Gb': 2**30,'b': 1,'B': 8,'TB':2*43,'Tb':40}
...
elif (address_mode == 'Word' or address_mode != 'Byte' or address_mode != 'Nibble' or address_mode != 'Bit'):
